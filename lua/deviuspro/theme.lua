...
theme.hl = function()
	...
	hl(0, 'Search', {fg=colors.aqua, bg='NONE'})
	...
	hl(0, 'PrePoc', { fg = colors.Decorator, bg = 'NONE' })
	hl(0, '@function.builtin', {fg = colors.aqua})	
	--
	--
	--
	--Html
	...
	hl(0, 'javascript', { fg = colors.red, bg = 'NONE' })
	...
	hl(0, 'cssColor', { fg = colors.gris, bg = 'NONE' })
	...
	hl(0, 'javascriptOperator', { fg = colors.Function, bg = 'NONE' })
	...
	hl(0, 'jsClassDefinition', { fg = colors.FuncCall, bg = 'NONE' })
	...
	hl(0, 'jsSpreadOperator', { fg = colors.gris, bg = 'NONE' })
	hl(0, 'jsSpreadExpression', { fg = colors.gris, bg = 'NONE' })
	--
	--
	--
	--
	...
	hl(0, 'goDeclaration', { fg = colors.Function, bg = 'NONE' })
	...
	hl(0, 'pythonFunction', { fg = colors.aqua, bg = 'NONE' })
	...
	hl(0, 'shStatement', { fg = colors.aqua, bg = 'NONE' })
	...
	hl(0, 'rustAttribute', { fg = colors.grisC, bg = 'NONE' })
	...
	hl(0, 'rustTrait', { fg = colors.aqua, bg = 'NONE' })
	hl(0, 'rustFoldBraces', { fg = colors.gris, bg = 'NONE' })
	hl(0, 'rustIdentifier', { fg = colors.aqua, bg = 'NONE' })
	hl(0, 'rustOperator', { fg = colors.operator, bg = 'NONE' })
	hl(0, 'rustkeyword', { fg = colors.red, bg = 'NONE' })
	hl(0, 'rustModPath', { fg = colors.grisC, bg = 'NONE' })
	hl(0, 'rustAssert', { fg = colors.aqua, bg = 'NONE' })
	hl(0, 'rustTypedef', { fg = colors.red, bg = 'NONE' })
	hl(0, 'rustType', { fg = colors.Type, bg = 'NONE' })
	hl(0, 'rustFoldBraces', { fg = colors.grisC, bg = 'NONE' })
	hl(0, 'rustBraces', { fg = colors.grisC, bg = 'NONE' })
	hl(0, 'rustVariable', { fg = colors.grisC, bg = 'NONE' })
	hl(0, 'rustaqua', { fg = colors.aqua, bg = 'NONE' })
	hl(0, 'rustBoxPlacementBalance', { fg = colors.grisC, bg = 'NONE' })
